...
public class Main {
    public static void main(String[] args) {
        ...
        // Считываем таблицу
        try (Scanner reader = new Scanner(Paths.get("/home/atom/Study/Fourth-Course/Семестр 1/Информационная безопасность/lab_1/src/main/resources/alphabet.txt"))) {
            len = reader.nextInt();
        ...
        try (Scanner reader = new Scanner(Paths.get("/home/atom/Study/Fourth-Course/Семестр 1/Информационная безопасность/lab_1/src/main/resources/text.txt"));) {   
        ...
        try (FileWriter writer = new FileWriter("/home/atom/Study/Fourth-Course/Семестр 1/Информационная безопасность/lab_1/src/main/resources/encrypted.txt", false))
        {
        ...
        try (FileWriter writer = new FileWriter("/home/atom/Study/Fourth-Course/Семестр 1/Информационная безопасность/lab_1/src/main/resources/decrypted.txt", false))
        {
